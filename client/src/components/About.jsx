...
const AboutUs = (props) => {
  return (
    <div>
      ...
      <p>
      The low prices aren't the only reason why we have so many loyal customers. Our support representatives are ready to take your calls to help you with any questions or scheduling deliveries. To make sure that you have the best possible service, we are only able to   
      </p>
    </div>
  );
};
